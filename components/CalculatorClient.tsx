...
export default function CalculatorClient() {
	...
	function validate(): boolean {
		...
		required.forEach((k) => {
			...
			if (!form[k] || isNaN(v) || v <= 0) newErrors[k] = "Wajib diisi dengan nilai positif"
		})
		setErrors(newErrors)
		...
		<div
			...
			<motion.nav
				...
				<div className="flex items-center gap-6">
					...
					<span className="flex items-center gap-1.5 text-white text-[0.8rem] tracking-widest uppercase">
						<Calculator size={13} />
						Calculator
					</span>
				</div>
			...
			<header
				...
				<motion.div
					...
					style={{
						background: "radial-gradient(circle, rgba(192,200,216,0.18) 0%, transparent 70%)",
					}}
				/>
				{/* decorative spring */}
				...
				<div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-10 py-12 w-full">
					...
					<motion.p
						...
						Masukkan data spesifikasi pegas untuk menghitung estimasi berat dan harga bahan (baja &
						stainless).
					</motion.p>
				</div>
			</header>
				...
				<motion.div
					...
					<form
									...
									<div className="relative">
										...
										<input
											...
											onFocus={(e) => {
												...
												e.currentTarget.style.boxShadow = "0 0 0 3px rgba(2,29,71,0.07)"
											}}
											onBlur={(e) => {
												e.currentTarget.style.border = errors[f.key]
													? "1.5px solid #f87171"
													: "1.5px solid rgba(2,29,71,0.1)"
												e.currentTarget.style.background = errors[f.key] ? "#fff5f5" : "#f8fafc"
						...
						<motion.div
							...
							<strong className="text-gray-500">ℹ️ Catatan:</strong> Jika jumlah lilitan tidak diisi atau
							bernilai 0, akan dihitung otomatis dari panjang ÷ pitch. Jika pitch juga kosong, diasumsikan{" "}
						...
						<motion.div
							...
							<motion.div
								...
								<button
									...
									<span className="font-semibold text-[#021d47] text-[0.88rem] flex items-center gap-2">
										<Settings2
											size={15}
								...
								<div
									id="breakdown-body"
									className="hidden">
									<div className="divide-y divide-[rgba(2,29,71,0.06)]">
										{[
											{
